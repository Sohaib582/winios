...
namespace SweetSugar.Scripts.MapScripts
{
    public class MapLevel : MonoBehaviour
    {
        ...
        public void playAsGuest()
        {
            ...
            {
                GoogleSignInDemo.Instance.logInPanel.gameObject.SetActive(false);
            }
            else
            {
                if (GoogleSignInDemo.Instance.signInButton.gameObject.activeInHierarchy && GoogleSignInDemo.Instance.CashoutButton.gameObject.activeInHierarchy == false)
                {
                    GoogleSignInDemo.Instance.logInPanel.gameObject.SetActive(true);
                }
            }
#endif
        }
