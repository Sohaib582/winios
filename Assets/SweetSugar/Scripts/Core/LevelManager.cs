...
//            GameObject.Find("CanvasMap/SafeArea/Gems").gameObject.SetActive(false);
        ...
        //Animations after win
          ...
          { 
            ...
            PlayerPrefs.SetInt("scorecount", PlayerPrefs.GetInt("scorecount")+ Score);


            //for server score
            PlayerPrefs.SetInt("serverScore", PlayerPrefs.GetInt("serverScore") + Score);

            //end level scores and type sent to server
            PlayerPrefs.SetInt("server", 0);
            PlayerPrefs.SetInt("server", Score);
            PlayerPrefs.SetString("type", "");
            PlayerPrefs.SetString("type", "level_complete_scores");
#if UNITY_ANDROID || UNITY_IOS
