...
namespace SweetSugar.Scripts.Core
{
    ...
    public class InitScript : MonoBehaviour
    {
       ...
       /* public void add500gems()
        ...
        public void add5000gems()
        {
            Gems = Gems + 5000;
        }
        public void add10000gems()
        {
            Gems = Gems + 10000;
        }
        public void add50000gems()
        {
            Gems = Gems + 50000;
        }
        ...
        void Awake()
        {
            ...
            Gems = PlayerPrefs.GetInt("scorecount");
            ...
            if (PlayerPrefs.GetInt("Lauched") == 0)
            {
               ...
               // PlayerPrefs.SetInt("Gems", Gems);
                PlayerPrefs.SetInt("scorecount", Gems);

                PlayerPrefs.SetInt("serverScore", Gems);
...
//        rate.GetComponent<RectTransform>().anchoredPosition = (Resources.Load("Prefabs/Rate") as GameObject).GetComponent<RectTransform>().anchoredPosition;
        ...
        public void SetGems(int count)
        {
           ...
           // PlayerPrefs.SetInt("Gems", Gems);
            ...
            PlayerPrefs.Save();
            //Set scores from api
            //GoogleSignInDemo.Instance.GetUpdatedScore();
        }
